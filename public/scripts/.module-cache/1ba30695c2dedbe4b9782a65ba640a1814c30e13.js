...
var SubmitBtn = React.createClass({displayName: "SubmitBtn",
	...
	render: function() {
		...
		if (this.props.enable){
			return React.createElement("button", {type: "submit", className: "btn btn-primary", onClick: this.handleClick}, "Submit ", React.createElement("i", {className: classes, ref: "spinning"}))
		}else{
			return React.createElement("button", {type: "submit", className: "btn btn-primary", disabled: "disabled"}, "Submit ", React.createElement("i", {className: classes, ref: "spinning"}))	
		}
...
var UsernameModal = React.createClass({displayName: "UsernameModal",
	...
	handleSubmit: function(e){
		...
		React.findDOMNode(this.refs.userName).value.setAttributes('disabled','disabled');
		return false;
	},
