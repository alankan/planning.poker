...
var SubmitBtn = React.createClass({displayName: "SubmitBtn",
	...
	render: function() {
		...
		if (this.props.enable){
			return React.createElement("input", {type: "submit", className: "btn btn-primary", onClick: this.handleClick, value: "Submit"}, " ", React.createElement("i", {className: classes, ref: "spinning"}))
		}else{
			return React.createElement("input", {type: "submit", className: "btn btn-primary", disabled: "disabled", value: "submit"}, React.createElement("i", {className: classes, ref: "spinning"}))	
		}
