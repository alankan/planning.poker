...
var SubmitBtn = React.createClass({displayName: "SubmitBtn",
	...
	render: function() {
		...
		return React.createElement("button", {type: "button", id: "submitBtn", className: "btn btn-primary", onClick: "{this.handleClick}"}, "Submit ", React.createElement("i", {className: "", ref: "spinning"}))
	}
})
