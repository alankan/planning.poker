...
var UsernameModal = React.createClass({displayName: "UsernameModal",
	render: function(){
		...
		return 
		React.createElement("div", {className: "modal fade", id: "userNameInputModal", tabindex: "-1", role: "dialog", "aria-labelledby": "userNameInputModalLabel"}, 
        ...
        React.createElement("div", {className: "modal-content"}, 
          ...
          React.createElement("div", {className: "modal-footer"}, 
            React.createElement("button", {type: "button", id: "submitBtn", className: "btn btn-primary"}, "Submit ", React.createElement("i", {className: "fa fa-circle-o-notch fa-spin hidden"}))
          )
        )
    	)
	  )
