...
var SubmitBtn = React.createClass({displayName: "SubmitBtn",
	...
	render: function() {
		...
		if (this.props.enable){
			return React.createElement("button", {type: "button", className: "btn btn-primary", onClick: this.handleClick}, "Submit")
		}else{
			return React.createElement("button", {type: "button", className: "btn btn-primary", disabled: "disabled"}, "Submit ", React.createElement("i", {className: classes, ref: "spinning"}))	
		}
